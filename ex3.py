"""
Estratégia: 
    A palavra será sorteada com base no arquivo lista_palavras.txt
    Depois, será recebido o input do jogador, com a tentativa
    Será feita uma validação do tamanho da palavra
    Comparação letra a letra das palavras, caso exista, é validado se a posição está correta, ao imprimir são colocadas as cores:
        azul: A letra existe mas não naquela posição
        vermelho: Letra não existe
        verde: Leta existe e está na posição correta
